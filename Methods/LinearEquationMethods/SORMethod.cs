...
namespace NumericalMethods.Methods.LinearEquationMethods
{
    public class SORMethod
    {
        ...
        {
            double a0 = 1, b0 = 1, c0 = 1, d0 = 1, e0 = 1, a1, b1, c1, d1, e1, e_1, e_2, e_3, e_4, e_5, e = 0.0000001, w = 1.25;
            int step = 1;

            do
            {
                a1 = (1 - w) * a0 + w * G1(a0, b0, c0, d0, e0);
                b1 = (1 - w) * b0 + w * G2(a1, b0, c0, d0, e0);
                c1 = (1 - w) * c0 + w * G3(a1, b1, c0, d0, e0);
                d1 = (1 - w) * d0 + w * G4(a1, b1, c1, d0, e0);
                e1 = (1 - w) * e0 + w * G5(a1, b1, c1, d1, e0);
